"""
Django settings for intsdd_6 project.
...
WSGI_APPLICATION = 'intsdd_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "intsdd_6 API",
    "DESCRIPTION": "API documentation for intsdd_6 App",
    "VERSION": "v1",
}
